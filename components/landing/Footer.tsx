    ...
    <footer className="bg-gray-900 text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-primary-400 to-accent-pink bg-clip-text text-transparent">
            ...
            <p className="text-sm text-gray-500">
              Join us for a vibrant celebration of life and mental health awareness.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a
                  href="mailto:info@jcimanilacolorrun.com"
                  className="hover:text-white transition-colors"
                >
                  info@jcimanilacolorrun.com
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-white transition-colors"
                >
                  sponsors@jcimanilacolorrun.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} JCI Manila Color Run. All rights reserved.</p>
